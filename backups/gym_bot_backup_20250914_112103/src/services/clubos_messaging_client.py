    ...
    def __init__(self, username: str = None, password: str = None):
        ...
        if not username or not password:
            try:
                ...
                username = username or secrets_manager.get_secret('clubos-username')
                password = password or secrets_manager.get_secret('clubos-password')
            except ImportError:
                logger.warning("SecureSecretsManager not available for ClubOS credentials")
