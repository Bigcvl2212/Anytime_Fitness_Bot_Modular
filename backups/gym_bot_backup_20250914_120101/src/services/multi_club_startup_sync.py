    ...
    try:
        ...
        try:
            ...
            if training_clients:
                ...
                # CRITICAL FIX: Save training clients to database immediately
                try:
                    ...
                    if success:
                        logger.info(f"💾 Successfully saved {len(training_clients)} training clients with billing data to database")
                    else:
