...
def create_app():
    ...
    with app.app_context():
        ...
        # Initialize automated access monitoring system (but don't start until login)
        try:
            try:
            ...
            app.start_monitoring = start_global_monitoring
            logger.info("🔐 Automated access monitoring initialized (will start after login)")
