...
class ClubHubAPIClient:
    ...
    def _make_request(self, method: str, url: str, params: Dict[str, Any] = None, 
        ...
        try:
            ...
            # Handle successful responses (200, 204)
            if response.status_code in [200, 204]:
                # For DELETE operations, 204 means success with no content
                ...
                try:
                    ...
                    print(f"⚠️ JSON parse error for {method} {url}: {json_error}")
                    return {"success": True, "message": "Non-JSON response", "content": response.text}
            else:
