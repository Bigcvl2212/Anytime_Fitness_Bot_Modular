        ...
        for client_id in selected_clients:
            try:
                if invoice_type == 'training_clients':
                    ...
                    cursor.execute("""
                        SELECT member_name, funding_cache 
                        FROM training_clients 
                    ...
                    if client:
                        ...
                        amount = funding_cache.get('amount_remaining', 50.0)  # Default to $50
                    ...
                    if member:
                        ...
                        # Use past due amount + late fee, or next payment
                        amount = past_due + (25.0 if past_due > 0 else 0) or next_payment or 50.0
                ...
                if invoice_url:
                    ...
                    failed_invoices.append({'client_id': client_id, 'error': 'Square invoice creation failed'})
